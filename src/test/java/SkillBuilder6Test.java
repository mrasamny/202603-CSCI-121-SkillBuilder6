...
class SkillBuilder6Test {
    ...
    void prefixAverage_1() {
        ...
        double [] actual = SkillBuilder6.prefixAverage(a);
    ...
    void indexOf_1() {
        ...
        int expected = 2;
        int actual = SkillBuilder6.indexOf(34,a);
    ...
    void indexOf_2() {
        int[] a = {88,15,34,8, 34,89,55,12};
        int expected = 0;
        int actual = SkillBuilder6.indexOf(88,a);
        assertEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void indexOf_3() {
        int[] a = {88,15,34,8, 34,89,55,12};
        int expected = -1;
        int actual = SkillBuilder6.indexOf(99,a);
        assertEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void IndexOfStrings_1() {
        ...
        int expected = 0;
        int actual = SkillBuilder6.indexOf("help",a);
        assertEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void IndexOfStrings_2() {
        String[] a = {"help","me","test","this","method","help"};
        int expected = 3;
        int actual = SkillBuilder6.indexOf("this",a);
        assertEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void IndexOfStrings_3() {
        String[] a = {"help","me","test","this","method","help"};
        int expected = -1;
        int actual = SkillBuilder6.indexOf("yelp",a);
        assertEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void remove_1() {
        ...
        String[] actual = SkillBuilder6.remove("this",a);
    ...
    void remove_2() {
        ...
        String[] actual = SkillBuilder6.remove("method",a);
        assertArrayEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void remove_3() {
        String[] a = {"help"};
        String[] expected = {};
        String[] actual = SkillBuilder6.remove("help",a);
        assertArrayEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void remove_5() {
        ...
        String[] actual = SkillBuilder6.remove("test",a);
        assertArrayEquals(expected,actual, "Expected: "+expected+"\nActual: "+actual);
    }
    ...
    void reverse_1() {
        ...
        SkillBuilder6.reverse(a);
        assertArrayEquals(expected,a, "Expected: "+expected+"\nActual: "+a);
    }

    @Test
    @DisplayName("[3] Test reverse_2")
    void reverse_2() {
        int[] a = {88,64};
        int[] expected = {64,88};
        SkillBuilder6.reverse(a);
